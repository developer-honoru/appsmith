...
class Camera2Widget extends BaseWidget<Camera2WidgetProps, WidgetState> {
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            label: "OnImageSave",
            controlType: "ACTION_SELECTOR",
            hidden: (props: Camera2WidgetProps) =>
...
export interface Camera2WidgetProps extends WidgetProps {
  isDisabled: boolean;
  isMirrored: boolean;
  isVisible: boolean;
  mode: CameraMode;
