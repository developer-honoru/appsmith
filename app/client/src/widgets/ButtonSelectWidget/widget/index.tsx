...
class ButtonSelectWidget extends BaseWidget<
  ButtonSelectWidgetProps,
  ButtonSelectWidgetState
> {
  onButtonClickBound: (event: React.MouseEvent<HTMLElement>) => void;
  clickWithRecaptchaBound: (token: string) => void;
  constructor(props: ButtonSelectWidgetProps) {
    super(props);
  ...
  static getWidgetType(): WidgetType {
    return "BUTTON_SELECT_WIDGET";
  }
}

export interface ButtonSelectWidgetProps extends WidgetProps {
  text?: string;
  onClick?: string;
  isDisabled?: boolean;
  isVisible?: boolean;
...
interface ButtonSelectWidgetState extends WidgetState {
  isLoading: boolean;
}

export default ButtonSelectWidget;
